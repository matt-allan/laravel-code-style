...
This package provides automatic code style checking and formatting for Laravel applications and packages.  It formats your code the same way Laravel itself is formatted.
